...
class ModeLoad extends React.Component {
    ...
    render() {
        return (
            <div>
                <Button className="btn" onClick={this.modalToggle}>Give Kudos</Button>

                <Modal isOpen={this.state.modal} toggle={this.modalToggle} className={this.className}>
                    <ModalHeader className='modalheader' toggle={this.modalToggle}><p className='heading'>Tell Them How You Feel!</p></ModalHeader>
                    ...
                    <ModalFooter className='modalfooter'>
                        <Button className='btn'  onClick={this.handlePost}> Post Kudos </Button>
